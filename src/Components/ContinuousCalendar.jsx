...
export default function ContinuousCalendar  ()  {
  ...
  return (
    <div className="no-scrollbar calendar-container max-h-screen overflow-y-scroll rounded-t-2xl bg-white pb-10 text-slate-800 shadow-xl" >
